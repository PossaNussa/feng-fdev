...
obsidian_boat = {
	initial_properties = {
		...
		-- lowering it causes the boat to fall through the world if underlava
...
function obsidian_boat.on_rightclick(self, clicker)
	if not clicker or not clicker:is_player() then
		return
	end
	local name = clicker:get_player_name()
	if self.driver and name == self.driver then
		-- Cleanup happens in obsidian_boat.on_detach_child
		clicker:set_detach()
...
function obsidian_boat.on_detach_child(self, child)
...
function obsidian_boat.on_activate(self, staticdata, dtime_s)
...
function obsidian_boat.get_staticdata(self)
	return tostring(self.v)
end


function obsidian_boat.on_punch(self, puncher)
	...
	if not self.driver then
		...
		if not minetest.is_creative_enabled(name)
				or not inv:contains_item("main", "more_boats:obsidian_boat") then
			local leftover = inv:add_item("main", "more_boats:obsidian_boat")
...
function obsidian_boat.on_step(self, dtime)
