tempsurvive={
	...
	nodes={
		["snowy"]={add=-8,rad=2},
		["water"]={add=-3,rad=2},
		["puts_out_fire"]={add=-4,rad=3},
		["water"]={add=-6,rad=0},
		["torch"]={add=5,rad=5},
		["default:steam"]={add=6,rad=2},
		["default:smoke"]={add=15,rad=1},
		["default:compressed_steam"]={add=12,rad=3},
		["default:ice"]={add=-6,rad=4},
		["default:fire"]={add=10,rad=10},
