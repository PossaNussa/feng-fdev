...
-- register golden jar node
minetest.register_node("wisp:jar_golden", {
    description = "Jar with Golden Wisp",
    inventory_image = "wisp_jar_golden_inv.png",
    wield_image = "wisp_jar_golden_inv.png",
    drawtype = "mesh",
    mesh = "wisp_jar.obj",
    tiles = {"wisp_jar.png"},
    paramtype = "light",
...
-- register on_placenode function for golden jar
minetest.register_on_placenode(function(pos, newnode)
    if newnode.name == "wisp:jar_golden" then
        table.insert(wisp.jars, {pos = pos, color = "golden"})
    end
end)
minetest.register_craft({
    output = "wisp:jar_golden",
    recipe = {
        {"default:gold_ingot", "default:gold_ingot", "default:gold_ingot"},
        {"default:gold_ingot", "wisp:jar_green", "default:gold_ingot"},
        {"default:gold_ingot", "default:gold_ingot", "default:gold_ingot"}
    }
})
