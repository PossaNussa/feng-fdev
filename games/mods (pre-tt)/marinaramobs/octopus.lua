...
stepheight = 0.0,
	...
	run_velocity = 2,
        fly = true,
	fly_in = "default:water_source", "default:river_water_source", "sailing:shallow_water_source", "default:water_flowing", "default:river_water_flowing",
	fall_speed = 0,
	runaway = false,
	jump = false,
	stepheight = 0.0,
...
mobs:spawn({
	...
	nodes = {"default:water_source", "sailing:shallow_water_source"},
	min_light = 0,
	interval = 80,
	chance = 3, -- 15000
	min_height = -30,
