...
visionLib._sMaterials={
	["iron"]=function()
		...
		if minetest.get_modpath("default") then
			visionLib.Common.SmartOverrideItem("default:steel_ingot", {groups={ingot_iron=1, ingot=1, iron=1, metal=1}})
			visionLib.Common.SmartOverrideItem("default:steelblock", {groups={block_iron=1, iron=1, metal_block=1}})
