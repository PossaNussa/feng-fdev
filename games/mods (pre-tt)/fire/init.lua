...
minetest.register_tool("fire:flint_and_steel", {
	description = S("Flint and Tinder"),
...
-- Flint and Steel
minetest.register_tool("fire:bowdrill", {
...
minetest.register_craft({
	output = "fire:bowdrill",
	recipe = {
		{"x_bows:bow", "default:stick"}
	}})
minetest.register_craft({
	output = "fire:flint_and_steel",
	recipe = {
		{"default:flint", "default:ironbar"}
	}
})
minetest.register_craft({
	output = "fire:flint_and_steel",
