...
if not goblins.db_fields["iron_drops"] then
    goblins.db_write("iron_drops", {
        ...
        {name = goblins.comp.default.shovel_diamond, chance = 1000, min = 0, max = 1},
        {name = goblins.comp.default.axe_diamond, chance = 1000, min = 0, max = 1},
        {name = goblins.comp.default.pick_steel, chance = 20, min = 0, max = 1},
        {name = goblins.comp.default.pick_iron, chance = 10, min = 0, max = 1},
        {name = goblins.comp.default.steel_ingot, chance = 7, min = 0, max = 1},
        {name = goblins.comp.default.axe_steel, chance = 10, min = 0, max = 1},
        {name = goblins.comp.default.axe_iron, chance = 5, min = 0, max = 1}
    })
end
...
if not goblins.db_fields["gob_drops"] then
    goblins.db_write("gob_drops", {
        ...
        {name = goblins.comp.default.cobble, chance = 3, min = 0, max = 8},
...
if not goblins.db_fields["template_drops"] then
    goblins.db_write("template_drops", {
        ...
        {name = goblins.comp.default.shovel_steel, chance = 2000, min = 0, max = 1},
        {name = goblins.comp.default.shovel_iron, chance = 1000, min = 0, max = 1},
        {name = goblins.comp.default.axe_steel, chance = 2000, min = 0, max = 1},
        {name = goblins.comp.default.axe_iron, chance = 1000, min = 0, max = 1},
