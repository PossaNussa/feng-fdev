...
goblins.comp = {
    default = {
        ...
        shovel_iron = "default:shovel_iron",
        ...
        sword_bronze = "default:sword_bronze",
        sword_steel = "default:sword_steel",
        sword_iron = "default:sword_iron",
