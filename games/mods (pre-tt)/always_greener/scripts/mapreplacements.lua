...
local replacers = {
	{
		...
		replacements = {
			[minetest.get_content_id 'default:dirt'] = minetest.get_content_id 'default:mud',
			[minetest.get_content_id 'default:dry_dirt'] = minetest.get_content_id 'default:mud',
			minetest.get_content_id 'default:mud',
