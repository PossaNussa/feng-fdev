...
minetest.register_alias(Liquid_name.water[source_name], source)
minetest.register_alias(Liquid_name.water[flowing_name], flowing)
...
minetest.register_alias(Liquid_name.lava[source_name], source)
minetest.register_alias(Liquid_name.lava[flowing_name], flowing)
...
minetest.register_alias("bucket:bucket_water_source", "default:water_source")
minetest.register_alias("bucket:bucket_water_flowing", "default:water_flowing")
minetest.register_alias("bucket:bucket_lava_source", "default:lava_source")
minetest.register_alias("bucket:bucket_lava_flowing", "default:lava_flowing")