...
local is_woodsoils_node = function(node_name)
	return string.match(node_name, "^woodsoils:")
end


local is_palm_node = function(node_name)
	return string.match(node_name, "^palm")
end
...
local get_node_box = function(node_name, node_def)
	...
	if (
		...
		(string.match(node_name, "canopy"))) and
		not is_woodsoils_node(node_name) and
		not is_palm_node(node_name)
	) then
