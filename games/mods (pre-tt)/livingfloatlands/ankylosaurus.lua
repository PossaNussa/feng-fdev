...
mobs:spawn({
	...
	nodes = {"default:dirt_with_grass", "variety:meadow_dirt_with_grass", "default:dry_dirt_with_dry_grass", "naturalbiomes:mediterranean_litter", "default:dirt_with_rainforest_litter"},
