...
x_farming.register_plant('x_farming:obsidian_wart', {
    description = S('Magic Wart Seed') .. '\n' .. S('Plant on Basalt') .. '\n' .. S('Compost chance') .. ': 30%',
    short_description = S('Magic Wart Seed'),
...
minetest.override_item('x_farming:obsidian_wart', {
    description = S('Magic Wart') .. '\n' .. S('Compost chance') .. ': 65%',
    short_description = S('Magic Wart'),
    groups = {
        -- X Farming
        compost = 65,
        -- MCL
...
if minetest.get_modpath('default') then
    ...
    minetest.register_node('x_farming:obsidian_soil', {
        description = S('Basalt Soil'),
        short_description = S('Basalt Soil'),
    ...
    minetest.register_node('x_farming:obsidian_soil_wet', {
        description = S('Wet Basalt Soil'),
        short_description = S('Wet Basalt Soil'),
        drop = 'default:obsidian',
