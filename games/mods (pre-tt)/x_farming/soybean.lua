...
minetest.register_craftitem('x_farming:bottle_soymilk', {
    description = S('Bottle of Soy Milk'),
    short_description = S('Bottle of Soy Milk'),
...
minetest.register_craftitem('x_farming:bottle_soymilk_raw', {
    description = S('Raw Bottle of Soy Milk'),
    short_description = S('Raw Bottle of Soy Milk'),
...
x_farming.register_crate('crate_soybean_3', {
    description = S('Crate of Soybeans'),
