...
local function spawnstep(dtime)
	...
	for _,plyr in ipairs(minetest.get_connected_players()) do
		...
		if stype == "default:water_source" or stype == "islands:water_source" or stype == "sailing:shallow_water_source" then 
			liquidflag = "sea"
		elseif stype == "default:river_water_source" or stype == "sailing:shallow_water_source" then
			liquidflag = "river"
