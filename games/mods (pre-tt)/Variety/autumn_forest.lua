...
---------------------------------------------
	stairs.register_stair_and_slab("autumn_forest_wood", "variety:autumn_forest_wood",
		...
		S("Autumn Forest Wood Stair"),
		S("Autumn Forest Wood Slab"),
		default.node_sound_wood_defaults())

default.register_mesepost("variety:mese_post_light_autumn_wood", {
	description = S("Autumn Wood Mese Post Light"),
	texture = "autumn_forest_wood.png",
	material = "variety:autumn_forest_wood",
})

minetest.register_node("variety:autumn_forest_grass", {
	description = S("Dirt With Autumn Forest Grass"),
...
minetest.register_node("variety:autumn_forest_leaves", {
	description = S("Autumn Tree Leaves"),
...
minetest.register_node("variety:autumn_forest_wood", {
	description = S("Autumn Wood Planks"),
...
doors.register_fencegate("variety:gate_autumn_forest", {
	description = S("Autumn Wood Fence Gate"),
	...
	default.register_fence("variety:fence_autumn_forest_wood", {
		description = S("Autumn Wood Fence"),
		texture = "autumn_forest_wood_fence.png",
	...
	default.register_fence_rail("variety:fence_rail_autumn_forest_wood", {
		description = S("Autumn Wood Fence Rail"),
		texture = "autumn_forest_wood_fence.png",
...
minetest.register_node("variety:pumpkin_block", {
	...
	tiles = {"autumn_forest_pumpkin_fruit_top.png", "autumn_forest_pumpkin_fruit_top.png", "autumn_forest_pumpkin_fruit_side.png", "autumn_forest_pumpkin_fruit_side.png", "autumn_forest_pumpkin_fruit_side.png", "autumn_forest_pumpkin_fruit_side.png"},
	paramtype2 = "facedir",
	sounds = default.node_sound_wood_defaults(),
	is_ground_content = false,
...
minetest.register_node("variety:autumn_forest_sapling", {
	description = S("Autumn Tree Sapling"),
	drawtype = "plantlike",
...
minetest.register_craftitem("variety:mushroom_bowl", {
	description = S("Mushroom Bowl Cooked"),
