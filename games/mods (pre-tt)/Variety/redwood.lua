...
minetest.register_node("variety:redwood_dirt_with_grass", {
	description = S("Dirt With Redwood Grass"),
...
minetest.register_node("variety:redwood_leaves", {
	description = S("Redwood Tree Leaves"),
...
minetest.register_node("variety:redwood_sapling", {
	description = S("Redwood Tre Sapling"),
	drawtype = "plantlike",
...
if minetest.get_modpath("bonemeal") ~= nil then
	...
	stairs.register_stair_and_slab("redwood", "variety:redwood",
		...
		{"redwood.png"},
		S("Redwood Wood Stair"),
		S("Redwood Wood Slab"),
		default.node_sound_wood_defaults())


default.register_mesepost("variety:mese_post_light_redwood", {
	description = S("Redwood Mese Post Light"),
	texture = "redwood.png",
	material = "variety:redwood",
})
