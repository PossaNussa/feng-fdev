...
mobs:register_mob("animalworld:kangaroo", {
	...
	jump_height = 8,
	pushable = true,
        stay_near = {{"naturalbiomes:outback_grass", "naturalbiomes:outback_grass3", "naturalbiomes:outback_grass2", "naturalbiomes:outback_grass4", "naturalbiomes:outback_grass5", "livingdesert:cactus", "livingdesert:cactus3", "livingdesert:cactus2", "livingdesert:cactus4", "default:dry_shrub"}, 5},
...
local spawn_on = {"badlands:red_sand", "default:dry_dirt_with_dry_grass"}

if minetest.get_mapgen_setting("mg_name") ~= "v6" then
	spawn_on = {"badlands:red_sand", "default:dry_dirt_with_dry_grass"}
end

if minetest.get_modpath("ethereal") then
	spawn_on = {"ethereal:grass_grove", "badlands:red_sand", "ethereal:dry_dirt"}
end

if not mobs.custom_spawn_animalworld then
mobs:spawn({
	name = "animalworld:kangaroo",
	nodes = {"badlands:red_sand", "naturalbiomes:outback_litter"},	min_light = 0,
	interval = 480,
	chance = 15500, -- 15000
...
on_spawn = function(self, pos)
			...
			local nods = minetest.find_nodes_in_area_under_air(
				...
				{x = pos.x + 4, y = pos.y + 3, z = pos.z + 4},
				{"badlands:red_sand", "naturalbiomes:outback_litter"})
