local names = {
		...
		"Ori", "Gimli", "Gamil", "Grendel Duvving", "Mr. Duvving", "Oren",
		...
		"Thorwynn", "Ankigellum, Champion of Novus", "Dodok Kullistem", "Sarvoresh",
		"Sarvesh", "Shem Zutthanedok", "Hush"
	}

-- Function to choose a random name from the names list
...
function lottmobs.register_dwarf(n, hpmin, hpmax, textures, wv, rv, damg, arm, drops, price)
    mobs:register_mob("lottmobs:dwarf" .. n, {
        ...
        on_spawn = function(self)
                self.unique_name = get_random_name(names) 
        end,
    ...
    mobs:register_spawn("lottmobs:dwarf" .. n, {"default:stone_with_iron", "default:granite_with_iron"}, 15, -1, 320000, 3, -10)
    mobs:register_spawn("lottmobs:dwarf" .. n, {"default:stone_with_coal", "default:granite_with_coal"}, 15, -1, 320000, 3, -10)
    mobs:register_spawn("lottmobs:dwarf" .. n, {"default:mossycobble", "default:cobble"}, 20, -1, 24000, 3, 310000)
