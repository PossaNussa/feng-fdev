...
minetest.register_decoration({
	...
	biomes = {"maire_forest", "tawa_forest", "naturalbiomes:wetsavanna", "pohutukawa_scrub", "pohutukawa_forest", "savanna", "naturalbiomes:mediterranean", "livingjungle:jungle", "rainforest", "cypress", "rainforest_swamp", "raupo_swamp"},
	sidelen = 16,
	noise_params = {
		offset = 0,
