...
def = {
	grow_on = mg and {"default:dirt_with_grass"} or {
			"naturalbiomes:mediterranean_litter", "default:silt"}
}
...
minetest.register_decoration({
	...
	sidelen = 16,
	biomes = {"naturalbiomes:mediterranean", "savanna", "tawa_forest", "naturalbiomes:wetsavanna", "maire_forest", "livingjungle:jungle"},
	noise_params = {
		offset = 0,
