...
local function get_bag_fs(fs, data, bag_size, yextra)
	-- Remove the bag list and related code
	...
	-- Hide or remove bag-related elements in the form specification
	image(0.5, yextra + 1.85, 0.6, 0.6, PNG.arrow_content) -- You can remove this line if you want to hide the arrow
	...
	-- Remove or comment out the bag rename functionality and related code
...
local function get_container(fs, data, player, yoffset, ctn_len, award_list, awards_unlocked, award_list_nb, bag_size)
	...
	fs("list[current_player;craft;%f,%f;2,2;]", 0, yoffset + 1.45)
