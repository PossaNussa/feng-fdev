...
mg_villages.grow_tree = function(data, a, pos, is_apple_tree, seed, snow)
    ...
    local c_sapling = minetest.get_content_id("dynamic_trees:apple_tree_sapling");
...
mg_villages.grow_jungletree = function(data, a, pos, seed, snow)
    ...
    local c_junglesapling = minetest.get_content_id("dynamic_trees:jungle_tree_sapling");
