...
register_craft( {
	output = "basic_materials:brass_ingot 9",
	recipe = {
		{materials.copper_ingot, "default:zincbar", materials.copper_ingot},
		{"default:zincbar", materials.copper_ingot, "default:zincbar"},
		{materials.copper_ingot, materials.copper_ingot, materials.copper_ingot},
	},
})
