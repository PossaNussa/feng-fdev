...
aotearoa.mamaku1 = {
	size = {y = 10, x = 1, z = 1,},
	data = {f1, f1, f1, f1, f1, f1, f1, f1, f1, f2,},
	yslice_prob = {},
}

aotearoa.mamaku2 = {
	size = {y = 15, x = 1, z = 1,},
	data = {f1, f1, f1, f1, f1, f1, f1, f1, f1, f1, f1, f1, f1, f1, f2,},
	yslice_prob = {},
}
...
aotearoa.cabbage_tree1 = {
	size = {y = 6, x = 1, z = 1,},
	data = {p1, p1, p1, p1, p1, p2,},
	yslice_prob = {},
}

aotearoa.cabbage_tree2 = {
	size = {y = 9, x = 1, z = 1,},
	data = {p1, p1, p1, p1, p1, p1, p1, p1, p2,},
	yslice_prob = {},
}
...
aotearoa.nikau_palm1 = {
	size = {y = 15, x = 1, z = 1,},
	data = {p3, p3, p3, p3, p3, p3, p3, p3, p3, p3, p3, p3, p3, p4, p5,},
	yslice_prob = {},
}

aotearoa.nikau_palm2 = {
	size = {y = 10, x = 1, z = 1,},
	data = {p3, p3, p3, p3, p3, p3, p3, p3, p4, p5,},
	yslice_prob = {},
}
