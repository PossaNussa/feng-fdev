...
minetest.register_node("default:furnace", {
	description = S("Kiln"),
    tiles = {
        "default_furnace_top.png^[colorize:#d2b48c:180",
        "default_furnace_bottom.png^[colorize:#d2b48c:180",
        "default_furnace_side.png^[colorize:#d2b48c:180",
        "default_furnace_side.png^[colorize:#d2b48c:180",
        "default_furnace_side.png^[colorize:#d2b48c:180",
        "default_furnace_front.png^[colorize:#d2b48c:180",
    },
	paramtype2 = "facedir",
	groups = {crumbly=2},
