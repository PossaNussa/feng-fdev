...
moretrees.palm_biome = {
	surface = "naturalbiomes:mediterranean_litter",
	avoid_nodes = moretrees.avoidnodes,
	avoid_radius = 5,
	seed_diff = 330,
	min_elevation = -1,
...
moretrees.spruce_biome = {
	surface = {"naturalbiomes:alpine_litter", "default:dirt_with_grass"},
	biomes = {"grove", "coniferous_forest", "naturalbiomes:alpine"},
	avoid_nodes = moretrees.avoidnodes,
	avoid_radius = 10,
	seed_diff = 335,
	min_elevation = 10,
...
moretrees.cedar_biome = {
	surface = {"naturalbiomes:mediterranean_litter", "default:dirt_with_grass"},
	avoid_nodes = moretrees.avoidnodes,
	biomes = {"coniferous_forest", "snowy_grassland", "naturalbiomes:mediterranean"},
	avoid_radius = 10,
	seed_diff = 336,
