...
mobs:spawn({
	...
	nodes = {"default:sand"},
	neighbors = {"group:grass", "group:normal_grass", "marinara:sand_with_seashells", "marinara:sand_with_seashells_pink", "marinara:sand_with_seashells_orange", "marinara:sand_with_seashells_yellow", "marinara:sand_with_seashells_brown", "marinara:sand_with_seashells_white"},
	min_light = 0,
	interval = 240,
	chance = 15500, -- 15000
