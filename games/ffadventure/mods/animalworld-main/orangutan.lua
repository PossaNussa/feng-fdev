...
mobs:register_mob("animalworld:orangutan", {
	...
	visual = "mesh",
	visual_size = {x = 1.6, y = 1.2, z = 1.44},
	mesh = "Orangutan.b3d",
	textures = {
...
mobs:spawn({
	...
	nodes = {"default:dirt_with_rainforest_litter", "default:jungleleaves", "group:dt_jungle_leaves"},
	min_light = 0,
	interval = 540,
	chance = 5000, -- 15000
...
mobs:register_egg("animalworld:orangutan", S("Orangutan"), "aorangutan.png")
