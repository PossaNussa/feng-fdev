...
mobs:register_mob("animalworld:gopher", {
	stepheight = 2,
	type = "animal",
	passive = false,
...
mobs:spawn({
	name = "animalworld:gopher",
	nodes = {"default:dirt_with_grass", "default:dirt_with_coniferous_litter", "redw:dirt_with_grass"},
	min_light = 0,
	interval = 360,
	chance = 5000, -- 15000
...
-- print("--- marmot at", minetest.pos_to_string(pos), iter)
				...
				for n = 1, iter do
					...
					if minetest.get_node(pos2).name == "air" then
						...
						mobs:add_mob(pos2, {
							name = "animalworld:gopher", child = kid})
					end
				end
			end
		end
...
mobs:register_egg("animalworld:gopher", S("Marmot"), "amarmot.png")


mobs:alias_mob("animalworld:gopher", "animalworld:gopher") -- compatibility
