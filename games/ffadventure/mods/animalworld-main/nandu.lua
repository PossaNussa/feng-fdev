...
mobs:register_mob("animalworld:ostrich", {
stepheight = 1,
	type = "animal",
	passive = false,
...
-- print("--- nandu at", minetest.pos_to_string(pos), iter)
				...
				for n = 1, iter do
					...
					if minetest.get_node(pos2).name == "air" then
						...
						mobs:add_mob(pos2, {
							name = "animalworld:ostrich", child = kid})
					end
				end
			end
		end
...
mobs:register_egg("animalworld:ostrich", ("Nandu"), "anandu.png", 0)


mobs:alias_mob("animalworld:andu", "animalworld:ostrich") -- compatibility
...
mobs:register_arrow("animalworld:egg_entity", {
	...
	hit_node = function(self, pos, node)
		...
		local mob = minetest.add_entity(pos, "animalworld:ostrich")
