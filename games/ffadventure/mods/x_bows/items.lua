...
XBows:register_arrow('arrow_wood', {
    ...
    short_description = S('Wood Arrow'),
...
XBows:register_arrow('arrow_bone', {
    ...
    short_description = S('Wood Arrow'),
    inventory_image = 'x_bows_arrow_wood.png^[colorize:E3DAC9:40',
    custom = {
        recipe = {
            { 'default:flint' },
            { 'group:bone' },
...
XBows:register_arrow('arrow_stone', {
    ...
    short_description = S('Stone Arrow'),
...
XBows:register_arrow('arrow_bronze', {
    ...
    short_description = S('Bronze Arrow'),
...
XBows:register_arrow('arrow_copper', {
    description = S('Copper Arrow'),
    short_description = S('Copper Arrow'),
    inventory_image = 'x_bows_arrow_bronze.png^[colorize:sienna:175^[colorize:red:40',
    custom = {
        recipe = {
            { 'default:flint' },
...
XBows:register_arrow('arrow_csteel', {
    description = S('Cobalt Steel Arrow'),
    short_description = S('Arrow Cobalt Steel'),
    inventory_image = 'x_bows_arrow_csteel.png',
    custom = {
        recipe = {
            { 'default:flint' },
...
XBows:register_arrow('arrow_diamond', {
    description = S('Titanium Arrow'),
    short_description = S('Arrow Titanium'),
