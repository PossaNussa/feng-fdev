...
minetest.register_decoration({
    ...
    sidelen = 16,
    fill_ratio = 0.01115,
    biomes = {"naturalbiomes:palmbeach", "sandy_beach",  "islands_beach", "islands_hot"},
    y_max = 5,
    y_min = 2,
...
if minetest.get_modpath("bonemeal") then
	bonemeal:add_deco({
		{"default:sand", {"naturalbiomes:palmbeach_grass1", "naturalbiomes:palmbeach_grass2", "naturalbiomes:palmbeach_grass3"}, {}}
	})
end
