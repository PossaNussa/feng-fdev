...
minetest.register_node("default:cobble", {
	description = S("True Cobblestone"),
	tiles = {"default_tcobble.png"},
...
minetest.register_craft({
    ...
    recipe = {
        {"default:limecobble", "default:quartzcobble", ""},
        {"default:onyxcobble", "default:rhyolitecobble", "default:basaltcobble"},
        {"default:granitecobble", "default:gneisscobble", "default:rhyolitecobble"}
    }
})
...
minetest.register_node("default:sand", {
	...
	tiles = {"default_sand.png",
		{name = "default_sand_side.png",
			tileable_vertical = false}},	groups = {crumbly = 3, falling_node = 1, sand = 1},
...
minetest.register_node("default:desert_sand", {
	...
	tiles = {"default_desert_sand.png",
		{name = "default_desert_sand_side.png",
			tileable_vertical = false}},
...
minetest.register_node("default:tree", {
	...
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2, falling_node = 1},
...
minetest.register_node("default:junglewood", {
	description = S("Balsa Wood Planks"),
	paramtype2 = "facedir",
	place_param2 = 0,
...
minetest.register_node("default:jungleleaves", {
	...
	drop = {
		...
		items = {
			...
			{items = {"default:jungleleaves"}, rarity = 25},
...
minetest.register_node("default:emergent_jungle_sapling", {
	description = S("Emergent Balsa Sapling"),
	drawtype = "plantlike",
...
minetest.register_node("default:pine_needles",{
	...
	drop = {
		...
		items = {
			...
			{items = {"default:pine_needles"}, rarity = 25},
			{items = {"default:stick"}, rarity = 5}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("default:acacia_leaves", {
	...
	drop = {
		...
		items = {
			...
			{items = {"default:acacia_leaves"}, rarity = 25},
			{items = {"default:stick"}, rarity = 5}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("default:aspen_leaves", {
	...
	drop = {
		...
		items = {
			...
			{items = {"default:aspen_leaves"}, rarity = 25},
			{items = {"default:stick"}, rarity = 5}
		}
	},
	sounds = default.node_sound_leaves_defaults(),
...
minetest.register_node("default:water_source", {
	...
	paramtype = "light",
            ...
            palette_index = 136,
            color = "#317873",
            palette = "luscious_w_palette.png",
	walkable = false,
	pointable = false,
	diggable = false,
	buildable_to = true,
...
default.register_fence("default:fence_junglewood", {
	description = S("Balsa Wood Fence"),
...
default.register_fence_rail("default:fence_rail_junglewood", {
	description = S("Balsa Wood Fence Rail"),
...
default.register_mesepost("default:mese_post_light_junglewood", {
	description = S("Balsa Wood Mese Post Light"),
	texture = "default_fence_junglewood.png",
	material = "default:junglewood",
})
