...
decoration = "flowers:waterlily_waving",
		...
		deco_type = "schematic",
		place_on = {"swamp:dirt_with_swamp_grass", "default:mud", "swamp:root_with_mud"},
		sidelen = 16,
		noise_params = {
			offset = 0.015,
			scale = 0.001,
...
local function register_mgv6_waterlily()
	minetest.register_decoration({
		...
		deco_type = "simple",
		place_on = {"default:mud", "swamp:dirt_with_swamp_grass"},
		sidelen = 16,
		noise_params = {
			offset = -0.12,
			scale = 0.3,
...
local function register_waterlily()
    minetest.register_decoration({
        ...
        deco_type = "simple",
        place_on = {"default:mud", "swamp:dirt_with_swamp_grass", "default:water_source"},
		 --place_on = {"swamp:root_with_mud", "default:mud", "swamp:dirt_with_swamp_grass", "default:water_source"},
        sidelen = 16,
        noise_params = {
            offset = -0.12,
            scale = 0.5,
