...
-- grass on cave floors
minetest.register_decoration({
    name       = "forest_cave:grass",
    deco_type  = "simple",
    place_on   = {"default:dirt", "default:clay", "default:mud", "group:stone"},
    sidelen    = 16,
    fill_ratio = 0.01,
    biomes     = {"forest_cave"},
    y_min      = -240,
...
-- vines on ceilings/walls inside forest_cave
minetest.register_decoration({
    name       = "forest_cave:vines",
    deco_type  = "simple",
    place_on   = {"default:dirt", "default:clay", "default:mud", "group:stone"},
    sidelen    = 16,
    fill_ratio = 0.002,
