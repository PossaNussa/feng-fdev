...
minetest.register_biome({
    ...
    depth_riverbed = 2,
    node_dungeon = "default:mud_brick",
    node_dungeon_alt = "default:mud",
    y_max = 10,
    y_min = -20,
    heat_point = 80,
    humidity_point = 98,
...
minetest.register_biome({
    ...
    node_dungeon = "default:mud_brick",
    node_dungeon_alt = "default:mud_block",
	vertical_blend = 1,
...
minetest.register_decoration({
	name = "default:liquid_mud_source",
	deco_type = "simple",
	...
	y_max = 31000,
	place_offset_y = -1,
	decoration = "default:liquid_mud_source",
	flags = "place_center_x, place_center_z, force_placement",
	rotation = "random",
})
