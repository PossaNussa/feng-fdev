...
function swamp.globalstep(dtime)
    for _, player in ipairs(minetest.get_connected_players()) do
        ...
        if player_node.name == "default:mud" then
            ...
            if two_blocks_down_node.name == "default:mud" then
...
if minetest.get_modpath("dungeon_loot") then
	dungeon_loot.register ({
		{name = "default:mud", chance = 0.1, count = {2, 9}},
		{name = "swamp:mangrove_sapling", chance = 0.3, count = {2, 4}},
		{name = "default:mud", chance = 0.3, count = {3, 12}},
