...
creatura.register_abm_spawn("animalia:song_bird", {
	...
	max_group = 12,
	spawn_cap = 6,
	nodes = {"default:leaves", "default:aspen_leaves", "default:jungleleaves", "animalia:nest_song_bird"},
	neighbors = {"default:leaves", "default:jungleleaves", "default:aspen_leaves"}
})
