...
metal_melter.register_melt("default:zincblock", "zinc", "block")
metal_melter.register_melt("default:ironblock", "iron", "block")

-- Special snowflake
metal_melter.register_melt("default:iron_lump", "iron", "lump")
