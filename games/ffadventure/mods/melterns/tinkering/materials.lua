...
--	},
	...
	bone = {
		cracky = {times={[3]=1.80}, uses=14, maxlevel=1},
		crumbly = {times={[1]=2.40, [2]=1.40, [3]=0.55}, uses=14, maxlevel=1},
		snappy = {times={[2]=1.5, [3]=0.40}, uses=14, maxlevel=1},
		choppy = {times={[2]=2,50, [3]=1.45}, uses=14, maxlevel=1},
		damagegroups = {fleshy = 3},
		explody = nil,

		binding = {increase = 0.03, uses = 1},
		rod = {increase = 0.03, uses = 1},
		tags = {
			{name = "primitive", description = "Primitive"},
	...
	stone = {
  	 ...
  	 iron = {
        	cracky = {times={[1]=3.90, [2]=1.55, [3]=0.75}, uses=25, maxlevel=2},
	        crumbly = {times={[1]=1.40, [2]=0.85, [3]=0.35}, uses=35, maxlevel=2},
       		snappy = {times={[1]=2.40, [2]=1.15, [3]=0.30}, uses=35, maxlevel=2},
        	choppy = {times={[1]=2.40, [2]=1.35, [3]=0.95}, uses=25, maxlevel=2},
        	damagegroups = {fleshy = 5},
        	explody = nil,

	        binding = {increase = 0.07, uses = 2},
        	rod = {increase = 0.04, uses = 7},
        	tags = {
        	    {name = "sturdy", description = "Sturdy"}
       		}
    	},
	steel = {
...
-- 	flint    = {name = "Flint",    default = "default:flint",    color = "#514E49", base = "item",               modifier = modifiers.flint},
	...
	bone     = {name = "Bone",     default = "bonemeal:bone",    color = "#E3DAC9", base = "group",              modifier = modifiers.wood},
	stone    = {name = "Stone",    default = "stone",            color = "#8D8988", base = "group",              modifier = modifiers.stone},
	obsidian = {name = "Basalt", default = "default:obsidian", color = "#2C384E", base = "node",  cast = true, modifier = modifiers.obsidian},

	-- Metals
	steel  = {name = "Steel",  default = "default:steel_ingot",  color = "#FFF",    base = "ingot", cast = true, modifier = modifiers.steel},
	iron   = {name = "Iron",  default = "default:ironbar",       color = "#D8D8D8", base = "ingot", cast = true, modifier = modifiers.iron},
	...
	-- From moreores
	silver  = {name = "Silver",  default = "default:silverbar",  color = "#D7E2E8", base = "ingot", cast = true, modifier = modifiers.silver},
	mithril = {name = "Mithril", default = "default:mithrilbar", color = "#6868D7", base = "ingot", cast = true, modifier = modifiers.mithril}
}
...
minetest.register_on_mods_loaded(function ()
		...
		tinkering.materials["chromium"] = {name = "Chromium", default = "default:chromebar",
			color = "#DFE8E8", base = "ingot", cast = true, modifier = modifiers.chromium}

		tinkering.materials["zinc"]     = {name = "Zinc",     default = "default:zincbar",
