...
moretrees.enable_apple_tree		= stg:get_bool("moretrees.enable_apple_tree", false)
moretrees.enable_oak			= stg:get_bool("moretrees.enable_oak", false)
...
moretrees.enable_willow			= stg:get_bool("moretrees.enable_willow", false)
moretrees.enable_birch			= stg:get_bool("moretrees.enable_birch", false)
...
moretrees.enable_fir			= stg:get_bool("moretrees.enable_fir", false)
