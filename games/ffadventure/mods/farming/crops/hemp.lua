...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"default:dirt_with_grass", "group:soil"},
	biomes = {"maire_forest", "tawa_forest", "naturalbiomes:wetsavanna", "pohutukawa_scrub", "pohutukawa_forest", "savanna", "naturalbiomes:mediterranean", "meadow", "islands", "islands_hot", "desert", "badlands", "naturalbiomes:palmbeach", "gumland", "sandstone_desert", "geothermal_scrub", "white_island", "mountain", "volcano"},
	sidelen = 16,
	noise_params = {
		offset = 0,
		scale = farming.hemp,
