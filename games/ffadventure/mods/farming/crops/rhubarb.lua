...
minetest.register_decoration({
	...
	sidelen = 16,
	biomes = {"pohutukawa_scrub", "pohutukawa_forest", "subantarctic_coast", "subantarctic_shore", "coniferous_forest", "grassland", "taiga", "rainforest", "deciduous_forest", "tundra", "redwood_forest"},
	noise_params = {
		offset = 0,
