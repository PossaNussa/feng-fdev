...
minetest.register_decoration({
	deco_type = "simple",
	place_on = {"default:dirt_with_grass", "naturalbiomes:mediterranean_litter", "group:soil"},
	biomes = {"deciduous_forest", "rainforest", "naturalbiomes:mediterranean", "grassland", "pohutukawa_scrub", "pohutukawa_forest", "island", "white_island"},
	sidelen = 16,
	noise_params = {
		offset = -0.1,
