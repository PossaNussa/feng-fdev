...
minetest.register_decoration({
	...
	biomes = {"maire_forest", "tawa_forest", "naturalbiomes:wetsavanna", "pohutukawa_scrub", "pohutukawa_forest", "savanna", "naturalbiomes:mediterranean", "meadow", "grassland", "rainforest", "deciduous_forest"},
	sidelen = 16,
	noise_params = {
		offset = 0,
