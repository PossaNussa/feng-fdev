...
minetest.register_decoration({
	...
	biomes = {"maire_forest", "tawa_forest", "naturalbiomes:wetsavanna", "pohutukawa_scrub", "pohutukawa_forest", "savanna", "naturalbiomes:mediterranean", "desert", "sandstone_desert", "badlands", "badlands_plains", "geothermal_scrub", "meadow", "grassland", "tussock"},
	sidelen = 16,
	noise_params = {
		offset = 0,
