...
minetest.register_decoration({
	...
	biomes = {"rainforest", "naturalbiomes:mediterranean", "prairie", "grassland", "snowy_grassland", "redwood_forest", "coniferous_forest", "deciduous_forest", "maire_forest", "tawa_forest", "taiga"},
	sidelen = 16,
	noise_params = {
		offset = 0,
