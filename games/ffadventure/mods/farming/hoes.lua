...
farming.register_hoe(":farming:hoe_bone", {
	description = S("Bone Plow"),
	inventory_image = "farming_tool_steelhoe.png^[colorize:E3DAC9:120",
	max_uses = 55,
	material = "bonemeal:bone"
})
...
farming.register_hoe(":farming:hoe_gold", {
	description = S("Gilded Plow"),
	inventory_image = "farming_tool_steelhoe.png^[colorize:gold:120",
	max_uses = 90,
	material = "default:gold_ingot"
})
farming.register_hoe(":farming:hoe_steel", {
	description = S("Steel Plow"),
	inventory_image = "farming_tool_steelhoe.png",
	max_uses = 330,
	material = "default:steel_ingot"
})
farming.register_hoe(":farming:hoe_iron", {
	description = S("Iron Plow"),
	inventory_image = "farming_tool_steelhoe.png^[colorize:grey:40",
	max_uses = 270,
	material = "default:ironbar"
})
farming.register_hoe(":farming:hoe_bronze", {
	description = S("Bronze Plow"),
...
farming.register_hoe(":farming:hoe_copper", {
	description = S("Copper Plow"),
	inventory_image = "farming_tool_bronzehoe.png^[colorize:sienna:175^[colorize:red:40",
	max_uses = 150,
	material = "default:copper_ingot"
})
farming.register_hoe(":farming:hoe_mese", {
	description = S("Mese Plow"),
	inventory_image = "farming_tool_mesehoe.png",
	max_uses = 350,
})

farming.register_hoe(":farming:hoe_diamond", {
	description = S("Diamond Plow"),
