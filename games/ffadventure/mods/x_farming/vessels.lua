...
-- At the end of your default/ropes.lua or equivalent
minetest.after(0, function()
    for _, node_def in pairs({
        'default:rope',
		'default:safety_net',
		'default:rope_fence',
        -- ... any other nodes you want to modify
    }) do
        if minetest.registered_nodes[node_def] then
            minetest.override_item(node_def, {
