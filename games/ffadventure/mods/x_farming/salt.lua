...
minetest.register_on_mods_loaded(function()
    ...
    if minetest.get_modpath('default') then
        ...
        table.insert(deco_place_on, 'badlands:red_sand')
        table.insert(deco_biomes, 'badlands_plains')
        table.insert(deco_biomes, 'badlands')
        table.insert(deco_place_on, 'biomes_island:dirt_with_island_litter')
        table.insert(deco_biomes, 'islands_hot')
        table.insert(deco_biomes, 'islands')
        table.insert(deco_biomes, 'islands_beach')
        table.insert(deco_biomes, 'islands_hot_beach')
        table.insert(deco_biomes, 'islands_ocean')
        table.insert(deco_biomes, 'islands_ocean_hot')
        table.insert(deco_place_on, 'default:sand')
        table.insert(deco_biomes, 'desert')
        table.insert(deco_place_on, 'default:sandstone')
