...
-- obsidian boat
minetest.register_entity("more_boats:obsidian_boat", obsidian_boat)
minetest.register_craftitem("more_boats:obsidian_boat", {
	description = S("Obsidian Boat"),
	inventory_image = "more_boats_obsidian_inv.png",
	wield_image = "more_boats_obsidian_wield.png",
	wield_scale = {x = 2, y = 2, z = 1},
	liquids_pointable = true,
	on_place = function(itemstack, placer, pointed_thing)
		local under = pointed_thing.under
		...
		pointed_thing.under.y = pointed_thing.under.y + 0.5
		boat = minetest.add_entity(pointed_thing.under, "more_boats:obsidian_boat")
		if boat then
			if placer then
				boat:set_yaw(placer:get_look_horizontal())
			end
...
minetest.register_craft({
	output = "more_boats:obsidian_boat",
	recipe = {
		{"", "", ""},
