...
nautilus.fuel = {['default:oil_source'] = {amount=5},['bucket:bucket_oil'] = {amount=1,drop="bucket:bucket_empty"},}
...
function nautilus.detect_player_api(player)
    ...
    local mesh = "3d_armor_character.b3d"
...
if minetest.get_modpath("default") then
    ...
    minetest.register_craft({
        ...
        recipe = {
            ...
            {"basic_materials:brass_ingot", "default:nickelbar",  "basic_materials:brass_ingot"},
            {"",                    "basic_materials:brass_ingot", "default:ironbar"},
        }
    })
    minetest.register_craft({
