function lottmobs.register_elf(n, hpmin, hpmax, textures, wv, rv, damg, arm, drops, price)
	...
	mobs:register_spawn("lottmobs:elf" .. n, {"default:dirt_with_grass"}, 20, 0, 380000, 3, 31000)
...
local drops1 = {
	{name = "dynamic_trees:apple_tree_sapling",
	chance = 5,
	min = 1,
	max = 3,},
	{name = "default:tree",
	...
	min = 1,
	max = 6,},
	{name = "default:cobaltbar",
	chance = 20,
	min = 1,
	max = 7},
	{name = "default:sword_csteel",
	chance = 20,
	min = 1,
	max = 1},
	{name = "spears:spear_csteel",
	chance = 25,
	min = 1,
	max = 1,},
	...
	min = 1,
	max = 1,},
	{name = "dynamic_trees:sakura_tree_sapling",
	chance = 250,
	min = 1,
	max = 1,},
