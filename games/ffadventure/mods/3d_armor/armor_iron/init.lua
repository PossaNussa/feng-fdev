...
if armor.materials.iron then
	...
	armor:register_armor(":3d_armor:helmet_iron", {
		...
		texture = "3d_armor_helmet_steel.png^[colorize:#B0B0B0:80",
	...
	armor:register_armor(":3d_armor:chestplate_iron", {
		...
		texture = "3d_armor_chestplate_steel.png^[colorize:#B0B0B0:80",
	...
	armor:register_armor(":3d_armor:leggings_iron", {
		...
		texture = "3d_armor_leggings_steel.png^[colorize:#B0B0B0:80",
	...
	armor:register_armor(":3d_armor:boots_iron", {
		...
		texture = "3d_armor_boots_steel.png^[colorize:#B0B0B0:80",
	...
	local s = "iron"
	local m = "default:ironbar" -- Corrected crafting material
