...
if armor.materials.wood then
	...
	armor:register_armor(":3d_armor:helmet_bone", {
		description = S("Bone Helmet"),
		inventory_image = "3d_armor_inv_helmet_wood.png^[colorize:white:192",
		groups = {armor_head=1, armor_heal=0, armor_use=2000, flammable=1},
	...
	armor:register_armor(":3d_armor:chestplate_wood", {
		...
		armor:register_armor(":3d_armor:chestplate_bone", {
		description = S("Bone Chestplate"),
		inventory_image = "3d_armor_inv_chestplate_wood.png^[colorize:white:192",
		groups = {armor_torso=1, armor_heal=0, armor_use=2000, flammable=1},
	...
	armor:register_armor(":3d_armor:leggings_wood", {
		...
		armor:register_armor(":3d_armor:leggings_bone", {
		description = S("Bone Leggings"),
		inventory_image = "3d_armor_inv_leggings_wood.png^[colorize:white:192",
		groups = {armor_legs=1, armor_heal=0, armor_use=2000, flammable=1},
		armor_groups = {fleshy=14},
		damage_groups = {cracky=3, snappy=2, choppy=3, crumbly=2, level=1},
	})
	...
	armor:register_armor(":3d_armor:boots_wood", {
		...
		armor:register_armor(":3d_armor:boots_bone", {
		description = S("Bone Boots"),
		inventory_image = "3d_armor_inv_boots_wood.png^[colorize:white:192",
	...
	minetest.register_craft({
		output = "3d_armor:chestplate_bone",
		recipe = {
			{"bonemeal:bone", "", "bonemeal:bone"},
			{"bonemeal:bone", "bonemeal:bone", "bonemeal:bone"},
			{"bonemeal:bone", "bonemeal:bone", "bonemeal:bone"},
