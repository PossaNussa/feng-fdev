...
if armor.materials.wood then
	...
	armor:register_armor("shields:shield_bone", {
		description = S("Bone Shield"),
		inventory_image = "shields_inv_shield_wood.png^[colorize:white:192",
		groups = {armor_shield=1, armor_heal=0, armor_use=2000, flammable=1},
...
if armor.materials.bronze then
	...
	armor:register_armor("shields:shield_bronze", {
		...
		armor:register_armor("shields:shield_copper", {
		description = S("Copper Shield"),
		inventory_image = "shields_inv_shield_bronze.png^[colorize:sienna:175^[colorize:red:40",
		groups = {armor_shield=1, armor_heal=3, armor_use=200,
...
armor:register_armor("shields:shield_iron", {
    description = S("Iron Shield"),
    inventory_image = "shields_inv_shield_steel.png^[colorize:#D0D0D0:40",  -- Apply the specified hex color with a subtle intensity
    groups = {armor_shield=1, armor_heal=4, armor_use=500,
        physics_speed=-0.03, physics_gravity=0.03},
    armor_groups = {fleshy=8},
    damage_groups = {cracky=2, snappy=3, choppy=2, crumbly=1, level=2},
    reciprocate_damage = true,
