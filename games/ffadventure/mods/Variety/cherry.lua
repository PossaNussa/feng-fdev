...
minetest.register_abm({
	...
	nodenames = {"variety:cherry_leaves"},
	interval = 6,
	chance = 24,
	catch_up = false,
	action = function(pos)
...
minetest.register_node("variety:cherry_dirt_with_grass", {
	description = S("Dirt With Cherry Grass"),
...
minetest.register_node("variety:cherry_leaves_on_the_ground", {
	description = S("Cherry Leaves on the ground"),
	drawtype = "signlike",
	waving = 1,
...
default.register_mesepost("variety:mese_post_light_cherry_wood", {
	description = S("Cherry Wood Mese Post Light"),
...
doors.register_fencegate("variety:gate_cherry", {
	...
	default.register_fence("variety:fence_cherry_wood", {
		description = S("Cherry Wood Fence"),
		texture = "cherry_wood_fence.png",
	...
	default.register_fence_rail("variety:fence_rail_cherry_wood", {
		description = S("Cherry Wood Fence Rail"),
		texture = "cherry_wood_fence.png",
...
minetest.register_decoration({
	...
	flags = "place_center_x, place_center_x, place_center_z",
	rotation = "random",
})
