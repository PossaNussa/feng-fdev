...
minetest.register_node("variety:dorwinion_brick", {
	description = S("Dorwninion Brick"),
	paramtype2 = "facedir",
	place_param2 = 0,
...
minetest.register_node("variety:dorwinion_brick_with_flowers", {
	description = S("Dorwninion Brick With Flowers"),
	paramtype2 = "facedir",
	place_param2 = 0,
...
minetest.register_node("variety:dorwinion_brick_with_moss", {
	description = S("Dorwninion Brick With Moss"),
	paramtype2 = "facedir",
	place_param2 = 0,
...
minetest.register_node("variety:dorwinion_carved", {
	description = S("Dorwninion Carved"),
	paramtype2 = "facedir",
	place_param2 = 0,
...
minetest.register_node("variety:dorwinion_brick_cracked", {
	description = S("Dorwninion Brick Cracked"),
	paramtype2 = "facedir",
	place_param2 = 0,
...
minetest.register_node("variety:dorwinion_leaves", {
	description = S("Dorwinion Tree Leaves"),
...
minetest.register_node("variety:dorwinion_glow_leaves", {
	description = S("Dorwinion Tree Glowing Leaves"),
	drawtype = "allfaces_optional",
	waving = 1,
...
minetest.register_node("variety:dorwinion_sapling", {
	description = S("Dorwinion Tree Sapling"),
	drawtype = "plantlike",
...
if minetest.get_modpath("bonemeal") ~= nil then
	...
	default.register_leafdecay({
		...
		leaves = {"variety:dorwinion_leaves", "default:aspen_leaves", "variety:dorwinion_glow_leaves"},
		radius = 3,
	})
---------------------------------------------
-------------WALLS
...
walls.register(":walls:dorwinion_brick", S("Dorwinion Brick Wall"), "dorwinion_brick.png",
		"variety:dorwinion_brick", default.node_sound_stone_defaults())

walls.register(":walls:dorwinion_carved", S("Dorwinion Carved Wall"), "dorwinion_carved.png",
