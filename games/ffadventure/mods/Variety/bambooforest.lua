...
default.register_mesepost("variety:mese_post_light_bamboo_wood", {
	description = S("Bamboo Wood Mese Post Light"),
	texture = "bamboo_wood.png",
...
default.register_mesepost("variety:mese_post_light_bamboo_block", {
	description = S("Bamboo Block Mese Post Light"),
	texture = "bamboo_block.png",
...
doors.register_fencegate("variety:gate_bamboo_wood", {
	...
	default.register_fence("variety:fence_bamboo_block", {
		description = S("Bamboo Block Fence"),
	...
	default.register_fence_rail("variety:fence_rail_bamboo_block", {
		description = S("Bamboo Block Fence Rail"),
		texture = "bamboo_block_fence.png",
...
minetest.register_node("variety:bamboo_sapling", {
	description = S("Bamboo Tree Sapling"),
	drawtype = "plantlike",
...
walls.register(":walls:bamboo_block", S("Bamboo Block Wall"), "bamboo_block.png",
		"variety:bamboo_block", default.node_sound_wood_defaults())

walls.register(":walls:granite_brick", S("Granite Brick Wall"), "granite_brick.png",
