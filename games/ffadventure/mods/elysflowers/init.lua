    ...
    for _, name in ipairs(def.variants) do
      if core.registered_nodes[name] then
        ...
        minetest.log("warning",
          ("[elysflowers] Skipping unknown variant '%s' (not registered)"):format(name))
      end
    end
  end
  ...
  variant_defs={
    {
      ...
      on_place=function(itemstack, placer, pointed_thing)
        ...
        local name = (variant == 0) and "elysflowers:purple_coneflower" or "elysflowers:purple_coneflower_1"
...
register_family({
  variants={ "elysflowers:fireweed", "elysflowers:fireweed_2", "elysflowers:fireweed_3", "elysflowers:fireweed_4" },
...
core.register_on_generated(function(minp, maxp, seed)
  ...
  for _, fam in ipairs(ELYS.families) do
    if fam.content_ids and #fam.content_ids > 0 then
      ...
      if DEBUG and fam_placed > 0 then
        minetest.log("action", ("[elysflowers] chunk (%d,%d)-(%d,%d) family placed: %d")
  ...
  if DEBUG and total_placed == 0 then
    minetest.log("action", ("[elysflowers] chunk (%d,%d)-(%d,%d): no placements")
...
local SPECIES = {
  ...
  { key="indian_paintbrush", title=S("Prairie Painter"), desc=S("Pick an Indian Paintbrush."), nodes={"elysflowers:indian_paintbrush"}, icon="indian_paintbrush.png" },
  { key="forget_me_not", title=S("Never Forget"), desc=S("Pick a Chinese forget-me-not."), nodes={"elysflowers:forget_me_not"}, icon="forget_me_not.png" },
  { key="foxglove", title=S("Border Bells"), desc=S("Pick a foxglove."), nodes={"elysflowers:foxglove"}, icon="foxglove2.png" },
  { key="hibiscus", title=S("Tropical Bloom"), desc=S("Pick a hibiscus."), nodes={"elysflowers:hibiscus"}, icon="hibiscus_flower.png" },
  { key="larkspur", title=S("Sky Lancer"), desc=S("Pick a larkspur."), nodes={"elysflowers:larkspur"}, icon="larkspur.png" },
  { key="black_eyed_susan", title=S("Summer’s Eye"), desc=S("Pick a black-eyed Susan."), nodes={"elysflowers:black_eyed_susan"}, icon="black_eyed_susan.png" },
  { key="phlox", title=S("Cottage Classic"), desc=S("Pick a phlox."), nodes={"elysflowers:phlox"}, icon="phlox.png" },

  -- Purple Coneflower — any variant counts
  { key="purple_coneflower", title=S("Cone of Power"), desc=S("Pick a purple coneflower."), nodes={"elysflowers:purple_coneflower","elysflowers:purple_coneflower_1"}, icon="purple_coneflower_0.png" },

  { key="california_poppy", title=S("Golden State"), desc=S("Pick a California poppy."), nodes={"elysflowers:california_poppy"}, icon="california_poppy.png" },
  { key="hyacinth", title=S("Spring Perfume"), desc=S("Pick a hyacinth."), nodes={"elysflowers:hyacinth"}, icon="hyacinth.png" },
  { key="lavender", title=S("Provence Breeze"), desc=S("Pick a lavender sprig."), nodes={"elysflowers:lavender"}, icon="lavender.png" },
  { key="marshmallow", title=S("Sweet Root"), desc=S("Pick a marshmallow plant."), nodes={"elysflowers:marshmallow"}, icon="marshmallow_1.png" },
  { key="yarrow_pink", title=S("Healer’s Fronds"), desc=S("Pick a yarrow."), nodes={"elysflowers:yarrow_pink"}, icon="yarrow.png" },
  { key="african_marigold", title=S("Sunward Bloom"), desc=S("Pick an African marigold."), nodes={"elysflowers:african_marigold"}, icon="marigold_1.png" },
  { key="arctic_poppy", title=S("Polar Petals"), desc=S("Pick an Arctic poppy."), nodes={"elysflowers:arctic_poppy"}, icon="arctic_poppy.png" },
  { key="dames_rocket", title=S("Evening Scent"), desc=S("Pick Dame’s rocket."), nodes={"elysflowers:dames_rocket"}, icon="dames_rocket.png" },
  { key="crocus", title=S("First to Wake"), desc=S("Pick a crocus."), nodes={"elysflowers:crocus"}, icon="crocus.png" },

  -- Fireweed — any variant counts
  { key="fireweed", title=S("After the Fire"), desc=S("Pick a fireweed."), nodes={"elysflowers:fireweed","elysflowers:fireweed_2","elysflowers:fireweed_3","elysflowers:fireweed_4"}, icon="fireweed.png" },

  { key="chamomile", title=S("Calm Cup"), desc=S("Pick a chamomile."), nodes={"elysflowers:chamomile"}, icon="chamomile.png" },
  { key="rose_pogonia", title=S("Bog Orchid"), desc=S("Pick a rose pogonia."), nodes={"elysflowers:rose_pogonia"}, icon="rose_pogonia.png" },
  { key="yellow_bell", title=S("Desert Bell"), desc=S("Pick a yellow bell."), nodes={"elysflowers:yellow_bell"}, icon="yellow_bell.png" },
  { key="bergamot", title=S("Bee Favorite"), desc=S("Pick a bergamot."), nodes={"elysflowers:bergamot"}, icon="bergamot.png" },
