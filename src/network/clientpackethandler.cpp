...
#include "nodedef.h"
#include "client/clientmap.h"     // ClientMap definition (for emergeSector)
#include "mapsector.h"            // MapSector definition
#include "database/database.h"    // MapDatabase definition (for loadBlock)
#include "mapblock.h"
