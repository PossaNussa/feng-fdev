...
#undef USEKEY2
    ...
    // When a player's inventory is marked as modified, the server will wait
...
// Level‑of‑detail (LOD) distance in nodes.  When a mapblock's centre is farther
	...
	// Larger values delay the LOD effect; smaller values increase it.  See
	// MapBlockMesh constructor for implementation details.  Units are in map
	// nodes; default is 200.
	settings->setDefault("lod_distance", "200.0");
